# У модулі 5 ми написали функцію sanitize_phone_number для нормалізації рядка з телефонним номером. Нагадаємо, що при
# отриманні рядків
#
#     "    +38(050)123-32-34",
#     "     0503451234",
...
# номерів префікс +38, а для повного міжнародного номера (з 12 символом) - тільки знак +. Реалізуйте декоратор
# format_phone_number для функції sanitize_phone_number з необхідним функціоналом.
#

def format_phone_number(func):
    def full_format(phone):
        new_phone = full_format(phone)
        print(new_phone)
