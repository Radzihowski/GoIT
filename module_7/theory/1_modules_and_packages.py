...
#
# У тій самій папці лежить основний скрипт cs_1_datetime.py, у якому ви б хотіли використати функцію add_bonus з
...
# з cs_1_datetime.py, де вам знадобилася функція add_bonus з salary_calculations.py. В такому випадку ви можете імпортувати
